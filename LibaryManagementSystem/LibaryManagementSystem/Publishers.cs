    ...
    class Publishers
    {
        ...
        public void Insert2List(List<Publishers> publishers)
        {
            if (publishers.Count == 0)
            {
                ...
                publishers1.Address = " Ho Chi Minh";
        ...
        private void ViewAll(List<Publishers> publishers)
        {
            ...
            {
                Console.WriteLine($"Publisher ID: {publisher.PublisherID} | Publisher Name: {publisher.PublisherName} | Address: {publisher.Address}");
            }
            Console.WriteLine();
        ...
        private void UpdatePublishers(List<Publishers> publishers)
        {
            ...
            Console.WriteLine($"Address: {objPublishers.Address}");
            Console.Write("==> ");
            temp = Console.ReadLine();
            if (temp != "")
            {
                objPublishers.Address = temp;
            }
        ...
        private void DeletePublishers(List<Publishers> publishers)
        {
            ...
            Console.WriteLine($"Publisher ID: {objPublishers.PublisherID} | Publisher Name: {objPublishers.PublisherName} | Address: {objPublishers.Address}");
